...
5. Added media="print" to avoid render blocking CSS in  print.css link.
...
1. Record timeline.
2. Identify where Forced Synchronoused Layout in Main.js
3. Made changes in UpdatePosition(), refactor changePizza Sizes() and reduce the number of pizzas rendered in the background.
4. Added comments.
5. Minified all the CSS and JavaScript files.
